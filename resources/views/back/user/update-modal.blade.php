      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('users/'.$item->id)}}" method="post">
            ...
            <div class="mb-3">
                <label for="password">Password (kosongkan jika tidak di isi)</label>
            ...
            <div class="mb-3">
                <label for="konfirmasi_password">Password</label>
                <input type="password" name="konfirmasi_password" id="konfirmasi_password" class="form-control @error('konfirmasi_password') is-invalid @enderror" value="{{ old('konfirmasi_password') }}">
                @error('password')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
